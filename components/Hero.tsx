    ...
    return (
        <div className='pb-20 pt-36'>
            <div>
                ...
                <Spotlight className='top-10 left-40 h-[80vh] w-[50vw]' fill='purple' />
            ...
            <div className="flex justify-center relative my-20 z-10">
                <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center'>
                    ...
                    <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">Hi I&apos;m Suresh Jat a Software Developer</p>
                    <a href="#">
